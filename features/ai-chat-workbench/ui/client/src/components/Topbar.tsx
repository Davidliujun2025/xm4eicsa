...
export default function Topbar() {
  return (
    <header className="flex items-center justify-between border-b border-slate-200/80 bg-white px-8 py-4">
      <div>
        <h1 className="text-[22px] font-bold tracking-tight text-slate-900">智能对话工作台</h1>
        <p className="mt-0.5 text-[13px] text-slate-400">AI 生成高质量回复，助力客服高效服务</p>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2">
          ...
          <span className="text-[14px] font-medium text-slate-700">张小倩</span>
